...
public class ImageController {
    ...
    private String callPythonScript(String imageUrl) {
        ...
        File file = new File("yourfile.txt"); // Relative path to the file
        String absolutePath = file.getAbsolutePath();
        return absolutePath;
//        return System.getProperty("user.dir");
//        command.add("C:/home/site/wwwroot/asterlink/rest/src/main/resources/py/script.py"); // Path to script
